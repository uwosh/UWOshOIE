...
function toggleCollapsibles() {
    ...
    for (var i=0; i < collapsibles.length; i++) {
        ...
        if (hasClassName(collapsible, 'collapsedBlockCollapsible')) {
            replaceClassName(collapsible, 'collapsedBlockCollapsible', 'expandedBlockCollapsible');
        } else if (hasClassName(collapsible, 'expandedBlockCollapsible')) {
            replaceClassName(collapsible, 'expandedBlockCollapsible', 'collapsedBlockCollapsible');
        } else if (hasClassName(collapsible, 'collapsedInlineCollapsible')) {
            replaceClassName(collapsible, 'collapsedInlineCollapsible', 'expandedInlineCollapsible');
        } else if (hasClassName(collapsible, 'expandedInlineCollapsible')) {
            replaceClassName(collapsible, 'expandedInlineCollapsible', 'collapsedInlineCollapsible');
        }
    }
};
...
/*    if (!W3CDOM) {return false;} */
    ...
    for (var i=0; i < collapsibles.length; i++) {
        ...
        if (hasClassName(collapsible, 'expandedBlockCollapsible')) {
            replaceClassName(collapsible, 'expandedBlockCollapsible', 'collapsedBlockCollapsible');
        } else if (hasClassName(collapsible, 'expandedInlineCollapsible')) {
            replaceClassName(collapsible, 'expandedInlineCollapsible', 'collapsedInlineCollapsible');
        }
