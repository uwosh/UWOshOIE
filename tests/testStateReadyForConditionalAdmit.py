...
class TestStateReadyForConditionalAdmit(UWOshOIETestCase):
    ...
    def createReadyForConditionalAdmitApplication(self):
    ...
    def test_should_be_in_readyForConditionalAdmit_state(self):
        app = self.createReadyForConditionalAdmitApplication()
    ...
    def test_should_be_able_to_admitConditionally(self):
        app = self.createReadyForConditionalAdmitApplication()
...
def test_suite():
    ...
    suite = TestSuite()
    suite.addTest(makeSuite(TestStateReadyForConditionalAdmit))
