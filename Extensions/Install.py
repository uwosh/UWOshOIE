...
from Products.UWOshOIE.config import product_globals as GLOBALS

def install(self):
    """ External Method to install UWOshOIE """
    out = StringIO()
    ...
    try:
        from Products.UWOshOIE.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    vocabmap = {u'UWOshOIEMajors': ('SimpleVocabulary', 'SimpleVocabularyTerm'),
         u'UWOshOIEPrograms': ('SimpleVocabulary', 'SimpleVocabularyTerm'),
         u'UWOshOIEEmphases': ('SimpleVocabulary', 'SimpleVocabularyTerm'),
         u'UWOshOIEMinors': ('SimpleVocabulary', 'SimpleVocabularyTerm'),
        }
